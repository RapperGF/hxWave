...
/*
    ...
    See <http://creativecommons.org/publicdomain/zero/1.0/>. // W
*/
#include <stdint.h>
...
class MP3
{
	static public function decodeMP3(file:Bytes)
	{
		...
		var raw:Star<Int8> = decodeMP3ToBuffer(cast RawPointer.addressOf(file.getData())[0], file.length, cast RawPointer.addressOf(sampleRate),
			cast RawPointer.addressOf(totSampleCount), cast RawPointer.addressOf(channels));
	...
	extern static function decodeMP3ToBuffer(buf:Star<UInt8>, music_size:Int, sampleRate:Star<UInt32>, totalSampleCount:Star<UInt32>,
		channels:Star<UInt32>):Star<Int8>;
}
/////////////////////////////////////////////////////////////////////////////////////